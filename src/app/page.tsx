    ...
    <div>
      ...
      <div className="my-6 px-3 max-w-3xl mx-auto">
        ...
        <p className="leading-relaxed">
          Hi there, I&apos;m Breno Vieira, a web developer. I started diving
          into web development back in 2021 during the pandemic out of my deep
          interest in technology and computers. Since then, I&apos;ve been
          happily building web applications for both leisure and to make my
          daily tasks easier. Now, I&apos;m eager to leverage my skills for a
          career and actively seeking opportunities.
          <br />
          Let me share a bit more about myself. I&apos;m Breno Vieira, 18 years
          old, based in Rio de Janeiro, Brazil. When I&apos;m not coding,
          you&apos;ll find me gaming with friends or catching up on my favorite
          anime series.
        </p>
          ...
          <div className="space-y-3">
            ...
            <p>
              ...
              {technologies
                ...
                .split('')
                .map((tech) => (
                  <strong key={tech} className="font-bold text-highlight">
                    {tech}
                  </strong>
                ))}{' '}
              and much more...
